...
<html lang="en">
    <head>
        ...
        <style>
            ...
            [hidden]{display:none}
            html{font-family:system-ui,-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Helvetica Neue,Arial,Noto Sans,sans-serif,Apple Color Emoji,Segoe UI Emoji;line-height:1.5}
        ...
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                <div class="flex justify-center pt-8 sm:justify-start sm:pt-0">
                    <h1 class="text-3xl font-bold">My Clinic Stater App</h1>
                </div>
                ...
                <div class="mt-8 bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg p-6">
                    <div class="flex space-x-4">
                        ...
                        <a href="{{ route('patients.index') }}" class="px-4 py-2 bg-gray-700 text-white rounded">Patients</a>
                    </div>
                </div>
            </div>
        </div>
